...
function Footer() {
  return (
    <>
    {/*footer start*/}
    <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 p-4 border-top container">
        <div className="col-md-4 d-flex align-items-center">
          <a href="/" className="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
            FarmaFriend
          </a>
          <span className="mb-3 mb-md-0 text-muted">Ecommerce Website for Farmers</span>
        </div>
